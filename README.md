...
![Marginalia Architecture Diagram](docs/architecture.png)
*Marginalia pipeline architecture: Deterministic arXiv retrieval, Strands agent reasoning, Qdrant Cloud semantic verification, and human-in-the-loop active learning.*
